...
/// <summary>Implementation of <see cref="Terminal.Gui.Views.CheckBoxTableSourceWrapperBase"/> which records toggled rows by their row number.</summary>
public class CheckBoxTableSourceWrapperByIndex : CheckBoxTableSourceWrapperBase
{
    ...
    /// <summary>
    ///     Gets the collection of all the checked rows in the <see cref="Terminal.Gui.Views.CheckBoxTableSourceWrapperBase.Wrapping"/>
